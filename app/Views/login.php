            ...
            <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                <div class="login-content">
                    ...
                    <form method="POST" action="/login/process" class="login-form">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <input id="email" type="email" class="form-control form-control-solid placeholder-no-fix form-group" name="email" placeholder="Email" required autofocus />
                            </div>
                            <div class="col-xs-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 text-right">
                                ...
                                <a href="/register" class="btn default">Daftar disini</a>
                            </div>
                        </div>
                    </form>
                </div>
